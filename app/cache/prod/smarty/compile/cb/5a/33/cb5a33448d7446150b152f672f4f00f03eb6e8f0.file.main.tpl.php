<?php /* Smarty version Smarty-3.1.19, created on 2017-02-17 13:14:28
         compiled from "C:\xampp\htdocs\prestashop\admin991coazqy\themes\default\template\controllers\translations\helpers\view\main.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1881658a6db14130c91-70965788%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'cb5a33448d7446150b152f672f4f00f03eb6e8f0' => 
    array (
      0 => 'C:\\xampp\\htdocs\\prestashop\\admin991coazqy\\themes\\default\\template\\controllers\\translations\\helpers\\view\\main.tpl',
      1 => 1487271003,
      2 => 'file',
    ),
    '0fee39abb38436550af54838544bac6a336419f8' => 
    array (
      0 => 'C:\\xampp\\htdocs\\prestashop\\admin991coazqy\\themes\\default\\template\\helpers\\view\\view.tpl',
      1 => 1487270997,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1881658a6db14130c91-70965788',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_58a6db14252eb0_95205560',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_58a6db14252eb0_95205560')) {function content_58a6db14252eb0_95205560($_smarty_tpl) {?>
	...
	<script type="text/javascript">
      ...
      $('select[name="selected-emails"]').on('change', function() {
        ...
        if ('modules' === $('#type option:selected').val() && '' === $('[name="selected-modules"]').val()) {
          alert('<?php echo smartyTranslate(array('s'=>'Please select a module!'),$_smarty_tpl);?>
');
          ...
          return;
				...
				if (0 === selectedLanguage.length) {
					alert('<?php echo smartyTranslate(array('s'=>'Please select your language!'),$_smarty_tpl);?>
');
...
"><?php echo $_smarty_tpl->tpl_vars['array']->value['name'];?>
      ...
      <div class="form-group" id="ps_email_selector">
        <label class="control-label col-lg-3" for="selected-emails"><?php echo smartyTranslate(array('s'=>'Select the type of email content'),$_smarty_tpl);?>
</label>
        <div class="col-lg-4">
          <select name="selected-emails">
            <option value="subject" data-controller="sf"><?php echo smartyTranslate(array('s'=>'Subject'),$_smarty_tpl);?>
</option>
            <option value="body" data-controller="legacy"><?php echo smartyTranslate(array('s'=>'Body'),$_smarty_tpl);?>
</option>
          </select>
        </div>
      </div>
      <div class="form-group" id="ps_module_selector">
        <label class="control-label col-lg-3" for="selected-modules"><?php echo smartyTranslate(array('s'=>'Select your module'),$_smarty_tpl);?>
</label>
        <div class="col-lg-4">
...
"><?php echo $_smarty_tpl->tpl_vars['module']->value['name'];?>
      ...
      <div class="form-group" id="ps_theme_selector">
        <label class="control-label col-lg-3" for="selected-theme"><?php echo smartyTranslate(array('s'=>'Select your theme'),$_smarty_tpl);?>
</label>
        <div class="col-lg-4">
          <select name="selected-theme">
              <option id="core-option" value=""><?php echo smartyTranslate(array('s'=>'Core (no theme selected)'),$_smarty_tpl);?>
</option>
...
" <?php if ($_smarty_tpl->tpl_vars['current_theme_name']->value==$_smarty_tpl->tpl_vars['theme']->value->getName()) {?>selected=selected<?php }?>><?php echo $_smarty_tpl->tpl_vars['theme']->value->getName();?>
      ...
      <div class="form-group">
        <label class="control-label col-lg-3" for="translations-languages"><?php echo smartyTranslate(array('s'=>'Select your language'),$_smarty_tpl);?>
</label>
        <div class="col-lg-4">
          <select name="locale" id="translations-languages">
            <option value=""><?php echo smartyTranslate(array('s'=>'Language'),$_smarty_tpl);?>
</option>
...
" selected="selected"><?php echo $_smarty_tpl->tpl_vars['theme']->value->getName();?>
 &nbsp;</option>
			...
			<div class="panel-footer">
				<button type="submit" name="submitImport" class="btn btn-default pull-right"><i class="process-icon-upload"></i> <?php echo smartyTranslate(array('s'=>'Import','d'=>'Admin.Actions'),$_smarty_tpl);?>
</button>
			</div>
		</div>
	</form>
...
" <?php if ($_smarty_tpl->tpl_vars['current_theme_name']->value==$_smarty_tpl->tpl_vars['theme']->value->getName()) {?>selected=selected<?php }?>><?php echo $_smarty_tpl->tpl_vars['theme']->value->getName();?>
			...
			<div class="panel-footer">
				<button type="submit" name="submitExport" class="btn btn-default pull-right"><i class="process-icon-download"></i> <?php echo smartyTranslate(array('s'=>'Export','d'=>'Admin.Actions'),$_smarty_tpl);?>
</button>
			</div>
		</div>
	</form>
...
, <b><a href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['url_create_language']->value,'html','UTF-8');?>
